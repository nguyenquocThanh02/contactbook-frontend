    ...
    <Form @submit="submitContact" :validation-schema="contactFormSchema"> 
        ...
        <div class="form-group form-check">
            <input type="checkbox" class="form-check-input"
                name="favorite" v-model="contactLocal.favorite"
            />
            <label for="favorite"><strong>Liên hệ yêu thích</strong></label>
        </div>
        <div class="form-group">
            <button class="btn btn-primary">Lưu</button>
            <button v-if="contactLocal._id" class="ml-2 btn btn-danger" type="button" @click="deleteContact">Xoá</button>
        </div>
    ...
    data(){
        const contactFormSchema = yup.object().shape({
            name: yup
                ...
                .min(2, "Tên phải it nhất 2 kí tự.")
                .max(50, "Tên nhiều nhất 50 kí tự."),
            email: yup 
                .string()
